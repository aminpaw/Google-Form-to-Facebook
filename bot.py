...
SAMPLE_SPREADSHEET_ID = '1XX1oFoYC_-fOb4-Iq3oo8vkTvOz-ll_s8dHTukd5ozU'
SAMPLE_RANGE_NAME = 'Form Responses 1'
page_id = 111163468197082
post_url = 'https://graph.facebook.com/{}/feed'.format(page_id)
AccessToken = "EAAcqac4gpAsBAJ1EB8TsQTHpTjIMT7gVHCZB60SZBsSZAF2O8Q10B67OeWWbOVbnmNgiEkXyfHJuXF7lVDEOZCbmivKNsEdGoQErl2HqL9aujjWfvQfrBjfFAFYHBHDAZCCxAdDnQTJfZAk7Dd2SexGOD6uQhr4KQMDJ0x465ecuKAlmJNtdJe"
        ...
        try:
            ...
            for row in processed_dataset:
                ...
                if (row[8] == "TRUE" and row[9]=="FALSE"):
                    Post_Number += 1
                    range_name = "Form Responses 1!J"+str(i)
                    values= [
                        ['TRUE'],
                        [Post_Number]
                        ]
